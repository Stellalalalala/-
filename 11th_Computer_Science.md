...
### 5-3. 尋找夥伴
在 HGSH online 中有各種挑戰，

為了最後能夠順利登出遊戲，你決定尋找志同道合的夥伴。

但是曾經組隊過的你知道，如果隊友等級比你低太多，對方很容易變成冗員；相反地，如果隊友等級比你高太多，則是你自己很容易變成冗員。

為了避免冗員的發生，在給定適合組隊的等級範圍後，請計算有多少人的等級在範圍之內。


◆輸入說明：第一行有兩個正整數 L 和 R，代表適合的等級下限和上限，接著有任意多行整數，代表每個人的等級，直到輸入 0 或 沒有值繼續輸入為止

◆輸出說明：有多少人的等級落在下限(含)到上限(含)之間
